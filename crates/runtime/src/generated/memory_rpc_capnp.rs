...
pub mod header {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 48] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 72, 101, 97, 100, 101, 114, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0xfe5a_f53f_cb7b_8d21;
    }
}
...
pub mod http_request {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 99] = [
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 72, 116, 116, 112, 82, 101, 113),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[3,2,0,4,1];
        pub(crate) const TYPE_ID: u64 = 0x932f_d0c7_5395_b73e;
    }
}
...
pub mod http_response {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 68] = [
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 72, 116, 116, 112, 82, 101, 115),
        ...
        pub(crate) const TYPE_ID: u64 = 0xe81c_5511_9c02_9733;
    }
}
...
pub mod method_call {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 65] = [
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 77, 101, 116, 104, 111, 100, 67),
        ...
        pub(crate) const TYPE_ID: u64 = 0xf037_76ff_d48c_453a;
    }
}
...
pub mod method_result {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 34] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(116, 1, 0, 0, 157, 1, 0, 0),
            ::capnp::word(21, 0, 0, 0, 242, 0, 0, 0),
            ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 77, 101, 116, 104, 111, 100, 82),
        ...
        pub(crate) const TYPE_ID: u64 = 0xa633_4991_06ed_322f;
    }
}
...
pub mod socket_message {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 65] = [
            ...
            ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(159, 1, 0, 0, 241, 1, 0, 0),
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 83, 111, 99, 107, 101, 116, 77),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[2,1,0];
        pub(crate) const TYPE_ID: u64 = 0x9c28_c756_2fc5_23ba;
    }
}
...
pub mod socket_close {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 65] = [
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 83, 111, 99, 107, 101, 116, 67),
        ...
        pub(crate) const TYPE_ID: u64 = 0x9c12_7adc_789d_99e0;
    }
}
...
pub mod socket_open {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 81] = [
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 83, 111, 99, 107, 101, 116, 79),
            ::capnp::word(112, 101, 110, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0xde0f_7593_3123_9fde;
    }
}
...
pub mod target {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 64] = [
            ...
            ::capnp::word(3, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(174, 2, 0, 0, 250, 2, 0, 0),
            ::capnp::word(21, 0, 0, 0, 194, 0, 0, 0),
            ::capnp::word(29, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 84, 97, 114, 103, 101, 116, 0),
            ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
            ::capnp::word(12, 0, 0, 0, 3, 0, 4, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 1, 0, 0, 0, 0, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,2,0];
        pub(crate) const TYPE_ID: u64 = 0xbe68_dacd_52f7_4325;
    }
}
...
pub mod invoke_request {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 64] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(252, 2, 0, 0, 109, 3, 0, 0),
            ::capnp::word(21, 0, 0, 0, 250, 0, 0, 0),
            ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(29, 0, 0, 0, 175, 0, 0, 0),
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 73, 110, 118, 111, 107, 101, 82),
        ...
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,2,0];
        pub(crate) const TYPE_ID: u64 = 0xa466_2e33_778c_6c82;
    }
...
pub mod invoke_response {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 64] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(111, 3, 0, 0, 227, 3, 0, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0x8b3a_ce1b_b356_d014;
    }
...
pub mod worker_socket_frame {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 65] = [
            ...
            ::capnp::word(109, 101, 109, 111, 114, 121, 95, 114),
            ::capnp::word(112, 99, 46, 99, 97, 112, 110, 112),
            ::capnp::word(58, 87, 111, 114, 107, 101, 114, 83),
            ::capnp::word(111, 99, 107, 101, 116, 70, 114, 97),
            ::capnp::word(109, 101, 0, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
            ::capnp::word(12, 0, 0, 0, 3, 0, 4, 0),
            ::capnp::word(0, 0, 255, 255, 0, 0, 0, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[0,1,2];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,0,2];
        pub(crate) const TYPE_ID: u64 = 0xe582_5ff6_40dd_8142;
    }
    pub enum Which<A0,A1,A2> {
        Message(A0),
        Close(A1),
