...
const MEMORY_READ_ASYNC_STORAGE_WORKER_SOURCE: &str = r#"
...
const MEMORY_READ_ASYNC_MEMORY_WORKER_SOURCE: &str = r#"
...
const MEMORY_READ_SYNC_MEMORY_WORKER_SOURCE: &str = r#"
export function read(_state) { return "1"; }
...
const MEMORY_DIRECT_READ_WORKER_SOURCE: &str = r#"
export function seed(state) {
  state.set("payload", "1");
  return true;
}
...
const MEMORY_DIRECT_WRITE_WORKER_SOURCE: &str = r#"
...
const MEMORY_ATOMIC_READ_MEMORY_WORKER_SOURCE: &str = r#"
export function seed(state) {
  state.set("payload", "1");
  return true;
}
...
const MEMORY_ATOMIC_READ_ALLOW_CONCURRENCY_MEMORY_WORKER_SOURCE: &str = r#"
export function seed(state) {
  state.set("payload", "1");
  return true;
}
...
const MEMORY_STM_INCREMENT_WORKER_SOURCE: &str = r#"
export function seed(state) {
  state.set("count", "0");
  return true;
}
...
const MEMORY_STM_READ_WRITE_WORKER_SOURCE: &str = r#"
export function seed(state) {
  state.set("count", "0");
  return true;
}
...
const MEMORY_STM_READ_WRITE_ALLOW_CONCURRENCY_WORKER_SOURCE: &str = r#"
export function seed(state) {
  state.set("count", "0");
  return true;
}
...
const MEMORY_STM_BLIND_WRITE_WORKER_SOURCE: &str = r#"
export function seed(state) {
  state.set("count", "0");
  return true;
}
...
const MEMORY_ATOMIC_PUT_INCREMENT_WORKER_SOURCE: &str = r#"
export function seed(state) {
  state.set("count", "0");
  return true;
}
...
fn print_profile(profile: &MemoryProfileSnapshot) {
    if !profile.enabled {
        return;
    }
    println!(
...
fn metric_mean_ms(metric: &MemoryProfileMetric) -> f64 {
    if metric.calls == 0 {
        0.0
    } else {
