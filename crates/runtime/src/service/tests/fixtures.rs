...
pub(super) struct TestKvProfileMetric {
    pub(super) calls: u64,
...
#[allow(dead_code)]
#[derive(Debug, Clone, Deserialize, Default)]
pub(super) struct TestKvProfileSnapshot {
    pub(super) enabled: bool,
    pub(super) op_get: TestKvProfileMetric,
    pub(super) js_cache_hit: TestKvProfileMetric,
    pub(super) js_cache_miss: TestKvProfileMetric,
    pub(super) js_cache_stale: TestKvProfileMetric,
    pub(super) js_cache_fill: TestKvProfileMetric,
    pub(super) js_cache_invalidate: TestKvProfileMetric,
}

#[derive(Debug, Clone, Deserialize, Default)]
pub(super) struct TestKvProfileEnvelope {
    pub(super) ok: bool,
    pub(super) snapshot: Option<TestKvProfileSnapshot>,
    pub(super) error: String,
}

pub(super) fn decode_kv_profile(output: WorkerOutput) -> TestKvProfileSnapshot {
...
pub(super) fn test_invocation() -> WorkerInvocation {
    WorkerInvocation {
...
pub(super) fn test_invocation_with_path(path: &str, request_id: &str) -> WorkerInvocation {
    WorkerInvocation {
        method: "GET".to_string(),
...
pub(super) fn test_websocket_invocation(path: &str, request_id: &str) -> WorkerInvocation {
    WorkerInvocation {
        method: "GET".to_string(),
        url: format!("http://worker{path}"),
        headers: vec![
...
pub(super) fn test_transport_invocation() -> WorkerInvocation {
    WorkerInvocation {
...
pub(super) fn counter_worker() -> String {
    r#"
let counter = 0;
export default {
  async fetch() {
...
pub(super) fn slow_worker() -> String {
    r#"
export default {
  async fetch() {
...
pub(super) fn dynamic_namespace_worker() -> String {
    r#"
let child = null;
...
pub(super) fn dynamic_plain_namespace_worker() -> String {
...
pub(super) fn dynamic_plain_namespace_worker_with_source(child_source: &str) -> String {
    format!(
        r#"
let child = null;
...
pub(super) fn dynamic_plain_handle_cache_worker() -> String {
    r#"
export default {
  async fetch(_request, env) {
...
pub(super) fn dynamic_fast_fetch_worker() -> String {
    r#"
let hotChild = null;
...
pub(super) fn dynamic_remote_fast_fetch_worker() -> String {
    r#"
let hotChild = null;
...
pub(super) fn dynamic_wake_probe_worker() -> String {
    r#"
...
pub(super) fn dynamic_namespace_ops_worker() -> String {
    r#"
function childConfig() {
  return {
    entrypoint: "worker.js",
...
pub(super) fn dynamic_repeated_create_worker() -> String {
    r#"
export default {
  async fetch(request, env) {
    const url = new URL(request.url);
...
pub(super) fn dynamic_snapshot_cache_worker() -> String {
    r#"
function childConfig() {
  return {
    entrypoint: "worker.js",
...
pub(super) fn dynamic_namespace_admin_worker() -> String {
    r#"
let slow = null;
...
pub(super) fn dynamic_handle_cache_delete_worker() -> String {
    r#"
...
pub(super) fn dynamic_response_json_worker() -> String {
    r#"
export default {
  async fetch(_request, env) {
...
pub(super) fn dynamic_runtime_surface_worker() -> String {
    r#"
...
pub(super) fn transport_echo_worker() -> String {
    r#"
export default {
  async fetch(request, env) {
...
pub(super) fn transport_shape_worker() -> String {
    r#"
export default {
  async fetch(request, env) {
...
pub(super) fn transport_values_worker() -> String {
    r#"
export default {
  async fetch(request, env) {
    return await env.MEDIA.get(env.MEDIA.idFromName("global")).atomic((state) => {
...
pub(super) fn websocket_storage_worker() -> String {
    r#"
...
pub(super) fn websocket_values_worker() -> String {
    r#"
function room(env) {
...
pub(super) fn websocket_socket_surface_worker() -> String {
    r#"
...
pub(super) fn dynamic_fetch_probe_worker(url: &str) -> String {
    format!(
        r#"
export default {{
  async fetch(_request, env) {{
...
pub(super) fn dynamic_fetch_abort_worker(url: &str) -> String {
    format!(
        r#"
export default {{
  async fetch() {{
...
pub(super) fn preview_dynamic_worker() -> String {
    r#"
...
pub(super) fn versioned_worker(version: &str, delay_ms: u64) -> String {
    format!(
        r#"
export default {{
  async fetch() {{
...
pub(super) fn io_wait_worker() -> String {
    r#"
export default {
  async fetch() {
...
pub(super) fn frozen_time_worker() -> String {
    r#"
export default {
  async fetch() {
    const now0 = Date.now();
...
pub(super) fn crypto_worker() -> String {
    r#"
export default {
  async fetch() {
...
pub(super) fn kv_batching_worker(worker_name: &str) -> String {
    format!(
        r#"
export default {{
...
pub(super) fn kv_write_worker() -> String {
    r#"
export default {
  async fetch(request, env, ctx) {
    const url = new URL(request.url);
...
pub(super) fn kv_wait_until_read_worker() -> String {
    r#"
export default {
  async fetch(request, env, ctx) {
    const url = new URL(request.url);
...
pub(super) fn reusable_env_worker() -> String {
    r#"
...
pub(super) fn abort_aware_worker() -> String {
    r#"
let abortCount = 0;
...
pub(super) fn malicious_completion_worker() -> String {
    r#"
let counter = 0;
...
pub(super) fn cache_worker(cache_name: &str, label: &str) -> String {
    format!(
        r#"
let count = 0;
...
pub(super) fn streaming_request_body_worker() -> String {
    r#"
export default {
  async fetch(request) {
...
pub(super) fn memory_worker() -> String {
    r#"
...
pub(super) fn memory_constructor_storage_worker() -> String {
    r#"
export default {
  async fetch(request, env) {
...
pub(super) fn memory_multi_atomic_read_worker() -> String {
    r#"
...
pub(super) fn memory_multi_key_storage_worker() -> String {
    r#"
export function seedCount(state) {
  state.set("count", "1");
  return true;
...
pub(super) fn hosted_memory_worker() -> String {
    r#"
...
pub(super) fn async_context_worker() -> String {
    r#"
export default {
  async fetch(request) {
    const url = new URL(request.url);
...
pub(super) fn trace_sink_worker() -> String {
    r#"
export default {
  async fetch(request) {
    return new Response("ok");
...
pub(super) fn wait_until_worker() -> String {
    r#"
...
pub(super) fn loop_trace_worker() -> String {
    r#"
let totalCalls = 0;
let traceCalls = 0;
...
#[derive(Deserialize)]
pub(super) struct LoopTraceState {
    pub(super) total_calls: usize,
    pub(super) trace_calls: usize,
}

#[derive(Deserialize)]
pub(super) struct FrozenTimeState {
    pub(super) now0: i64,
    pub(super) now1: i64,
    pub(super) now2: i64,
    pub(super) perf0: f64,
...
pub(super) struct CryptoState {
    pub(super) random_length: usize,
    pub(super) random_non_zero: bool,
    pub(super) uuid: String,
    pub(super) digest_length: usize,
}

pub(super) async fn test_service(config: RuntimeConfig) -> RuntimeService {
...
pub(super) async fn test_service_with_paths(
...
pub(super) fn dynamic_single_isolate_config() -> RuntimeConfig {
    RuntimeConfig {
        min_isolates: 1,
        max_isolates: 1,
...
pub(super) fn dynamic_autoscaling_config() -> RuntimeConfig {
    RuntimeConfig {
        min_isolates: 0,
        max_isolates: 2,
...
pub(super) fn dynamic_bench_autoscaling_config() -> RuntimeConfig {
    RuntimeConfig {
        min_isolates: 0,
        max_isolates: 8,
        max_inflight_per_isolate: 4,
...
pub(super) async fn invoke_with_timeout_and_dump(
...
pub(super) async fn wait_for_isolate_total(service: &RuntimeService, worker_name: &str, expected: usize) {
...
pub(super) fn test_assets() -> Vec<DeployAsset> {
    vec![
        DeployAsset {
            path: "/a.js".to_string(),
...
pub(super) fn asset_worker() -> String {
    r#"
export default {
  async fetch() {
...
pub(super) fn asset_headers_file() -> String {
    r#"
/a.js
