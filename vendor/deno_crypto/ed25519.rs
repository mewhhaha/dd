...
#[op2(fast)]
pub fn op_crypto_import_spki_ed25519(#[buffer] key_data: &[u8], #[buffer] out: &mut [u8]) -> bool {
    // 2-3.
...
#[op2(fast)]
pub fn op_crypto_import_pkcs8_ed25519(#[buffer] key_data: &[u8], #[buffer] out: &mut [u8]) -> bool {
    // 2-3.
...
#[op2]
pub fn op_crypto_export_spki_ed25519(#[buffer] pubkey: &[u8]) -> Result<Uint8Array, Ed25519Error> {
...
#[op2]
pub fn op_crypto_export_pkcs8_ed25519(#[buffer] pkey: &[u8]) -> Result<Uint8Array, Ed25519Error> {
...
#[op2]
#[string]
pub fn op_crypto_jwk_x_ed25519(#[buffer] pkey: &[u8]) -> Result<String, Ed25519Error> {
