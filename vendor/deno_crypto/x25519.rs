...
#[op2(fast)]
pub fn op_crypto_generate_x25519_keypair(#[buffer] pkey: &mut [u8], #[buffer] pubkey: &mut [u8]) {
    let mut rng = OsRng;
    rng.fill_bytes(pkey);
...
pub fn op_crypto_x25519_public_key(#[buffer] private_key: &[u8]) -> String {
    ...
    let private_key: [u8; 32] = private_key.try_into().expect("Expected byteLength 32");
    BASE64_URL_SAFE_NO_PAD.encode(x25519_dalek::x25519(private_key, X25519_BASEPOINT_BYTES))
}
...
#[op2(fast)]
pub fn op_crypto_import_spki_x25519(#[buffer] key_data: &[u8], #[buffer] out: &mut [u8]) -> bool {
    // 2-3.
...
#[op2(fast)]
pub fn op_crypto_import_pkcs8_x25519(#[buffer] key_data: &[u8], #[buffer] out: &mut [u8]) -> bool {
    // 2-3.
...
#[op2]
pub fn op_crypto_export_spki_x25519(#[buffer] pubkey: &[u8]) -> Result<Uint8Array, X25519Error> {
...
#[op2]
pub fn op_crypto_export_pkcs8_x25519(#[buffer] pkey: &[u8]) -> Result<Uint8Array, X25519Error> {
