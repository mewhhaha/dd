...
#[op2(fast)]
pub fn op_crypto_generate_x448_keypair(#[buffer] pkey: &mut [u8], #[buffer] pubkey: &mut [u8]) {
    let mut rng = OsRng;
    rng.fill_bytes(pkey);
...
#[op2]
pub fn op_crypto_export_spki_x448(#[buffer] pubkey: &[u8]) -> Result<Uint8Array, X448Error> {
...
#[op2]
pub fn op_crypto_export_pkcs8_x448(#[buffer] pkey: &[u8]) -> Result<Uint8Array, X448Error> {
...
#[op2(fast)]
pub fn op_crypto_import_spki_x448(#[buffer] key_data: &[u8], #[buffer] out: &mut [u8]) -> bool {
    // 2-3.
...
#[op2(fast)]
pub fn op_crypto_import_pkcs8_x448(#[buffer] key_data: &[u8], #[buffer] out: &mut [u8]) -> bool {
    // 2-3.
