...
export function meta() {
  return [{ title: "Edge Goods RSC storefront" }];
}
...
export async function ServerComponent({ loaderData }: { loaderData: LoaderData }) {
  return (
        ...
        <section className="grid gap-6">
          <div className="grid gap-4">
            ...
            <p className="max-w-[56ch] text-base/7 text-pretty text-neutral-600 sm:text-sm/6">
              Server route components render a small shop from KV catalog rows, memory cart
              state, and checkout order records inside dd.
            </p>
          </div>
        ...
        <section className="@container grid gap-4" aria-labelledby="catalog-heading">
          <div className="flex items-end justify-between gap-4">
            <div className="grid gap-2">
              ...
              <p className="max-w-[56ch] text-base/7 text-pretty text-neutral-600 sm:text-sm/6">
                The RSC loader seeds the catalog on first request and reads product records back
                from KV.
              </p>
            </div>
            <Link
